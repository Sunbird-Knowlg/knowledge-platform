...
@Singleton
class FrameworkCategoryController @Inject()(@Named(ActorNames.FRAMEWORK_CATEGORY_ACTOR) frameworkCategoryActor: ActorRef,cc: ControllerComponents)(implicit exec: ExecutionContext)  extends BaseController(cc) {
