error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Relation.java:org/neo4j/graphdb/Node#
file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Relation.java
...
offset: 243
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Relation.java
text:
```scala
