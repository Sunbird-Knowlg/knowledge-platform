error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/NodeQueryGenerationUtil.java:GraphDACParams/SET#
file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/NodeQueryGenerationUtil.java
empty definition using pc, found symbol in pc: GraphDACParams/SET#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 20149
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/NodeQueryGenerationUtil.java
text:
```scala
