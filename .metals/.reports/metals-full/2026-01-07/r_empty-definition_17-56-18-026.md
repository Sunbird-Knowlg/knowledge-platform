error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Neo4JBoltGraphOperations.java:org/sunbird/graph/service/util/GraphQueryGenerationUtil#
file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Neo4JBoltGraphOperations.java
empty definition using pc, found symbol in pc: org/sunbird/graph/service/util/GraphQueryGenerationUtil#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 796
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Neo4JBoltGraphOperations.java
text:
```scala
