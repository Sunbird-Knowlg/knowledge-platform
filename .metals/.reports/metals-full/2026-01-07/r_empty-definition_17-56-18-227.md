error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Neo4JBoltSearchOperations.java:org/sunbird/graph/service/util/SearchQueryGenerationUtil#
file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Neo4JBoltSearchOperations.java
empty definition using pc, found symbol in pc: org/sunbird/graph/service/util/SearchQueryGenerationUtil#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 588
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/Neo4JBoltSearchOperations.java
text:
```scala
