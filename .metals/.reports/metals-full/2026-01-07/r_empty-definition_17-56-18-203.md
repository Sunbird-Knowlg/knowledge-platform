error id: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/NodeAsyncOperations.java:org/sunbird/graph/service/util/NodeQueryGenerationUtil#
file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/NodeAsyncOperations.java
empty definition using pc, found symbol in pc: org/sunbird/graph/service/util/NodeQueryGenerationUtil#
empty definition using semanticdb
empty definition using fallback
non-local guesses:

offset: 1485
uri: file://<WORKSPACE>/ontology-engine/graph-dac-api/.neo4j-backup/NodeAsyncOperations.java
text:
```scala
