...
public class RelationTest {
    ...
    private static Relation relation_1 = null;
    private static Relation relation_2 = null;
    private static Relation relation_3 = null;
    private static Relation relation_4 = null;
    private static Relation relation_5 = null;
    private static Relation relation_6 = null;
    ...
    public static void setup() throws Exception {
        ...
        org.neo4j.graphdb.Node startNode = (org.neo4j.graphdb.Node) resultMap.get("m");
        org.neo4j.graphdb.Node endNode = (org.neo4j.graphdb.Node) resultMap.get("n");
        relation_1 = new Relation();
        relation_2 = new Relation("start_1234", "DATA_NODE", "end_1234");
        try (Transaction tx=graphDb.beginTx()) {
            relation_3 = new Relation(graphId, relationship);
            tx.success();
        }
    }
    ...
    public void test2(){
        relation_4 = new Relation(graphId, null);
    }

    @Test(expected = ServerException.class )
    public void test3(){
        relation_5 = new Relation(graphId, null, null, null);
    }
    ...
    private static void startEmbeddedNeo4j() {
