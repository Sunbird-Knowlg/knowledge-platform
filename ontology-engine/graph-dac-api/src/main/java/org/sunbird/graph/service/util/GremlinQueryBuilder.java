...
public class GremlinQueryBuilder {
     ...
     */
    public static GraphTraversal<Edge, Edge> updateEdge(GraphTraversalSource g, String graphId,
            String startNodeId, String endNodeId, String relationType, Map<String, Object> metadata) {
        
        GraphTraversal<Edge, Edge> traversal = g.V()
                .has(SystemProperties.IL_UNIQUE_ID.name(), startNodeId)
                .has("graphId", graphId)
                .outE(relationType)
     ...
     * Delete edge
     */
    public static GraphTraversal<Edge, Edge> deleteEdge(GraphTraversalSource g, String graphId,
    ...
    public static GraphTraversal<Vertex, Edge> getOutgoingEdges(GraphTraversalSource g, String graphId, String identifier, String relationType) {
        GraphTraversal<Vertex, Edge> traversal = getVertexByIdentifier(g, graphId, identifier);
        
        if (StringUtils.isNotBlank(relationType)) {
            return traversal.outE(relationType);
        } else {
