...
abstract class IDefinition(graphId: String, schemaName: String, version: String = "1.0") extends CoreDomainObject(graphId, schemaName, version) {
    ...
    @throws[Exception]
    def getNode(identifier: String, operation: String = "read", mode: String, nodeVersioning: String = null)(implicit oec: OntologyEngineContext, ec: ExecutionContext): Future[Node]
