...
class BaseDefinitionNode(graphId: String, schemaName: String, version: String = "1.0") extends IDefinition(graphId, schemaName, version) {
    ...
    override def getNode(identifier: String, operation: String, mode: String, nodeVersioning: String = null)(implicit oec: OntologyEngineContext, ec: ExecutionContext): Future[Node] = {
