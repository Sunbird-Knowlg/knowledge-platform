...
class BaseSpec extends AsyncFlatSpec with Matchers with BeforeAndAfterAll {
    ...
    private val script_14 = "INSERT INTO category_store.category_definition_data (identifier, objectmetadata) VALUES ('obj-cat:scorm-content_content_all', {'config': '{}', 'schema': '{\"properties\":{\"launchFile\":{\"type\":\"string\"},\"scormVersion\":{\"type\":\"string\"},\"scoList\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"properties\":{\"identifier\":{\"type\":\"string\"},\"title\":{\"type\":\"string\"},\"href\":{\"type\":\"string\"},\"parameters\":{\"type\":\"string\"}}}}}}'});"
    ...
    def setupGraphData(): Unit = {
      ...
      createVertex("domain", Map[String, AnyRef]("IL_UNIQUE_ID" -> "obj-cat:scorm-content_content_all", "identifier" -> "obj-cat:scorm-content_content_all", "name" -> "SCORMContent", "description" -> "SCORM content", "categoryId" -> "obj-cat:scorm-content", "targetObjectType" -> "Content", "status" -> "Live", "objectMetadata" -> "{\"config\":{},\"schema\":{\"properties\":{\"launchFile\":{\"type\":\"string\"},\"scormVersion\":{\"type\":\"string\"},\"scoList\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"properties\":{\"identifier\":{\"type\":\"string\"},\"title\":{\"type\":\"string\"},\"href\":{\"type\":\"string\"},\"parameters\":{\"type\":\"string\"}}}}}}}", "IL_SYS_NODE_TYPE" -> "DATA_NODE", "IL_FUNC_OBJECT_TYPE" -> "ObjectCategoryDefinition"))
