...
class BaseSpec extends AsyncFlatSpec with Matchers with BeforeAndAfterAll {
  ...
  private val script_14 = "INSERT INTO category_store.category_definition_data (identifier, objectmetadata) VALUES ('obj-cat:digital-textbook_collection_all', {'config': '{}', 'schema': '{}'});"
