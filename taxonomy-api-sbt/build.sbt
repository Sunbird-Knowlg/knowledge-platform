...
lazy val taxonomyService = (project in file("taxonomy-service-sbt"))
...
lazy val taxonomyActors = (project in file("taxonomy-actors-sbt"))
  .settings(
  name := "taxonomy-actors-sbt",
  version := "1.0-SNAPSHOT",
  commonSettings,
  libraryDependencies ++= Seq(
