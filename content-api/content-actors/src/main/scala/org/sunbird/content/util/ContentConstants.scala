...
object ContentConstants {
    ...
    val CHANNEL_ID: String = "X-Channel-Id"
    val ERR_CONTENT_CONTENT_TYPE: String = "ERR_CONTENT_CONTENT_TYPE"
    val ERR_CONTENT_INVALID_CHANNEL: String = "ERR_CONTENT_INVALID_CHANNEL"
    val CHANNEL: String = "channel"
    val COUNT: String = "count"
    val ERR_INVALID_COUNT: String = "ERR_INVALID_COUNT"
    val RESERVED_DIAL_CODES: String = "reservedDialcodes"
    val MESSAGES: String = "messages"
    val NODE_ID: String = "node_id"
    val PUBLISHER: String = "publisher"
    val DIAL_CODES: String = "dialcodes"
    val SERVER_ERROR: String = "SERVER_ERROR"
