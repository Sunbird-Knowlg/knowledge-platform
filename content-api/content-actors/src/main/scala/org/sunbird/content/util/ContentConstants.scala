...
object ContentConstants {
    ...
    val ERR_CHANNEL_BLANK_OBJECT = "ERR_CHANNEL_BLANK_OBJECT"
    val CHANNEL_ID = "X-Channel-Id"
    val ERR_CONTENT_CONTENT_TYPE = "ERR_CONTENT_CONTENT_TYPE"
    val ERR_CONTENT_INVALID_CHANNEL = "ERR_CONTENT_INVALID_CHANNEL"
    val CHANNEL = "channel"
    val COUNT = "count"
    val ERR_INVALID_COUNT = "ERR_INVALID_COUNT"
    val RESERVED_DIAL_CODES = "reservedDialcodes"
