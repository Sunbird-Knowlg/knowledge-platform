...
class TestHierarchy extends BaseSpec {
    ...
    "addLeafNodesToHierarchy for shallowcopied" should "throw client exception " in {
        ...
        recoverToSucceededIf[ResourceNotFoundException](HierarchyManager.addLeafNodesToHierarchy(request))
    ...
    "getHierarchyBeforeUpdateHierarchyWithMode" should "getHierarchyWithoutChildren" ignore {
        val request = new Request()
    ...
    "getHierarchy mode=edit" should "return latest leafNodes" ignore {
    ...
    "getHierarchy mode=edit with bookmark" should "return latest leafNodes for bookmark" ignore {
    ...
    "getHierarchy mode=edit" should "return removing retired or deleted leafNodes" ignore {
